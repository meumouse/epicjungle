...
class Merlin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		require_once trailingslashit( $this->base_path ) . 'inc/' . $this->directory . '/includes/class-merlin-logger.php';
	...
	function required_classes() {
		...
		require_once trailingslashit( $this->base_path ) . 'inc/' . $this->directory . '/includes/class-merlin-downloader.php';

		$this->importer = new ProteusThemes\WPContentImporter2\Importer( array( 'fetch_attachments' => true ), $this->logger );

		require_once trailingslashit( $this->base_path ) . 'inc/' . $this->directory . '/includes/class-merlin-widget-importer.php';

		if ( ! class_exists( 'WP_Customize_Setting' ) ) {
			require_once ABSPATH . 'wp-includes/class-wp-customize-setting.php';
		}

		require_once trailingslashit( $this->base_path ) . 'inc/' . $this->directory . '/includes/class-merlin-customizer-option.php';
		require_once trailingslashit( $this->base_path ) . 'inc/' . $this->directory . '/includes/class-merlin-customizer-importer.php';
		require_once trailingslashit( $this->base_path ) . 'inc/' . $this->directory . '/includes/class-merlin-hooks.php';
	...
	public function admin_page() {
		...
		// Enqueue styles.
		wp_enqueue_style( 'merlin', trailingslashit( $this->base_url ) . 'inc/' . $this->directory . '/assets/css/merlin' . $suffix . '.css', array( 'wp-admin' ), MERLIN_VERSION );

		// Enqueue javascript.
		wp_enqueue_script( 'merlin', trailingslashit( $this->base_url ) . 'inc/' . $this->directory . '/assets/js/merlin' . $suffix . '.js', array( 'jquery-core' ), MERLIN_VERSION );

		$texts = array(
			'something_went_wrong' => esc_html__( 'Something went wrong. Please refresh the page and try again!', 'epicjungle' ),
		);
	...
	//	$spinner = $this->directory . '/assets/images/spinner.php';
		$spinner = get_template_directory() . '/inc/merlin/assets/images/spinner.php';
