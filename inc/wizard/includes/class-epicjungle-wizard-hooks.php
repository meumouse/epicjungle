...
class EpicJungle_Wizard_Hooks {
	/**
	 * The class constructor.
	 */
	public function __construct() {
		add_action( 'epicjungle_wizard_widget_settings_array', array( $this, 'fix_custom_menu_widget_ids' ) );
	...
	public function after_all_import_action( $selected_import_index ) {
		do_action( 'epicjungle_wizard_after_all_import', $selected_import_index );
	...
	public function maybe_disable_creating_different_size_images_during_import() {
		if ( ! apply_filters( 'epicjungle_wizard_regenerate_thumbnails_in_content_import', true ) ) {
