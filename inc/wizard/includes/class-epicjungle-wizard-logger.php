...
class EpicJungle_Wizard_Logger {
	/**
	 ...
	 */
	protected function __construct( $log_path = null, $name = 'epicjungle-wizard-logger' ) {
		$this->log_path = $log_path;
		$this->logger_name = $name;

		if ( empty( $this->log_path ) ) {
			$upload_dir = wp_upload_dir();
			$logger_dir = $upload_dir['basedir'] . '/epicjungle-wizard-wp';
