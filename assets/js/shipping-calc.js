	...
	$(function(){
		...
		$('#wscp-button').on('click',function(){
			...
			if( !detected ) {
				...
				$('#span-shipping-calc').addClass('d-none');
				$('#preloader-shipping-calc').removeClass('d-none');
				...
				$.ajax({
					...
					success: function(response){
						...
						$('#preloader-shipping-calc').addClass('d-none');
						$('#span-shipping-calc').removeClass('d-none');
