...
<button type="button" class="btn btn-primary rounded-pill btn-icon" id="yith-wcwl-wishlistexistsbrowse"  data-toggle="tooltip" data-placement="bottom" title="Ver favoritos">
